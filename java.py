        ...
        if (wait == 0):
            if ('wikipedia' in query or 'who is' in query or 'विकीपीडिया' in query or 'कौन है' in query ):
                ...
                speak(result)
                          ...
                          "pause" in query or "break" in query or "sleep" in query or "timeout" in query or 'आराम' in query or 'सो जाओ' in query) and check == 0):
                if (lang == "en-ind"):
                    speak("As you wish")
                else:
                ...
                if ('india' in query or 'इंडिया' in query or 'भारत' in query):
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&country=in&lang=' + bhasha).text

                elif ('business' in query or 'व्यापार' in query):
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&topic=business&lang=' + bhasha).text

                elif ('health' in query or 'स्वास्थ्य' in query):
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&topic=health&lang=' + bhasha).text

                elif ('sports' in query or 'sport' in query or 'खेल' in query):
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&topic=sports&lang=' + bhasha).text

                elif ('technology' in query or 'तकनीकी' in query):
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&topic=technology&lang=' + bhasha).text

                elif ('entertainment' in query or 'मनोरंजन' in query):
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&topic=entertainment&lang=' + bhasha).text
                else:
                    data = requests.get(
                        'https://gnews.io/api/v4/top-headlines?token=9060ccba0667f2e015587342f06d7df7&topic=world&lang=' + bhasha).text
                ...
                g = geocoder.ip('me')
                url = "https://api.weatherbit.io/v2.0/forecast/daily?&lat=" + str(g.latlng[0] - .26) + "&lon=" + str(
                    g.latlng[1] - .23) + "&key=c8a42097ee0148de82b6fe4c5e85b6b5"
                ...
                if (lang == 'en-ind'):
                    ...
                    d = {'Thunderstorm with light rain': 'हल्की बारिश के साथ आंधी',
                         'Thunderstorm with rain': 'बारिश के साथ तूफान',
                         'Thunderstorm with heavy rain': 'भारी बारिश के साथ तूफान',
                         'Thunderstorm with light drizzle': 'हल्की बूंदा बांदी के साथ तूफान',
                         'Thunderstorm with drizzle': 'बूंदा बांदी के साथ तूफान',
                         'Thunderstorm with heavy drizzle': 'भारी बूंदा बांदी के साथ तूफान',
                         'Thunderstorm with Hail': 'गरज के साथ छींटे', 'Light Drizzle': 'हल्की बूंदाबांदी',
                         'Drizzle': 'बूंदा बांदी', 'Heavy Drizzle': 'बूंदा बांदी', 'Light Rain': 'हलकी बारिश',
                         'Moderate Rain': 'औसत दर्जे की वर्षा', 'Heavy Rain': 'भारी वर्षा',
                         'Freezing rain': 'हिमीकरण बारिश', 'Light shower rain': 'हल्की बौछार बारिश',
                         'Shower rain': 'बौछार बारिश', 'Heavy shower rain': 'भारी बारिश', 'Light snow': 'हलकी बर्फ',
                         'Snow': 'बर्फ', 'Heavy Snow': 'भारी बर्फ', 'Mix snow/rain': 'बर्फ',
                         'Sleet': 'ओले के साथ वर्षा', 'Heavy sleet': 'भारी स्लीट', 'Snow shower': 'स्नो शॉवर',
                         'Heavy snow shower': 'भारी बर्फबारी', 'Flurries': 'आंधी', 'Mist': 'कोहरा', 'Smoke': 'धुआं',
                         'Haze': 'धुंध', 'Sand/dust': 'धूल', 'Fog': 'कोहरा', 'Freezing Fog': 'अत्यधिक ठंडा कोहरा',
                         'Clear sky': 'साफ आसमान', 'Few clouds': 'थोडे बादल', 'Scattered clouds': 'बिखरे हुए बादल',
                         'Broken clouds': 'बादल', 'Overcast clouds': 'बादल छाए',
                         'Unknown Precipitation': 'अज्ञात वर्षा',
                         'Thunderstorm with light rain': 'हल्की बारिश के साथ आंधी',
                         'Thunderstorm with rain': 'बारिश के साथ तूफान',
                         'Thunderstorm with heavy rain': 'भारी बारिश के साथ तूफान',
                         'Thunderstorm with light drizzle': 'हल्की बूंदा बांदी के साथ तूफान',
                         'Thunderstorm with drizzle': 'बूंदा बांदी के साथ तूफान',
                         ...
                         'Haze': 'धुंध', 'Sand/dust': 'धूल', 'Fog': 'कोहरा', 'Freezing Fog': 'अत्यधिक ठंडा कोहरा',
                         'Clear sky': 'साफ आसमान', 'Few clouds': 'थोडे बादल', 'Scattered clouds': 'बिखरे हुए बादल',
                         'Broken clouds': 'बादल', 'Scattered clouds': 'बिखरे हुए बादल', 'Broken clouds': 'बादल',
                         'Overcast clouds': 'बादल छाए', 'Unknown Precipitation': 'अज्ञात वर्षा'}
                    translator = Translator(service_urls=['translate.googleapis.com'])
                    l = ['शून्य', 'एक', 'दो', 'तीन', 'चार', 'पांच', 'छह', 'सात', 'आठ', 'नौ', 'दस', 'ग्यारह', 'बारह',
                         'तेरह', 'चोदह', 'पंद्रह', 'सोलह', 'सत्त्रह', 'अट्ठारह', 'उन्नीस', 'बीस', 'इक्कीस', 'बाइस',
                         'तेईस',
                         'चौबीस', 'पच्चीस', 'छब्बीस', 'सत्ताइस', 'अट्ठाइस', 'उन्तीस', 'तीस', 'इकतीस', 'बत्तीस', 'तैतीस',
                         'चौतीस', 'पैतीस', 'छत्तीस', 'सैतीस', 'अड़तीस', 'उन्तालीस', 'चालीस', 'इकतालीस', 'बयालीस',
                         'तिरतालिस', 'चौवालीस', 'पैतालीस', 'छयालीस', 'सैतालिस', 'अड़तालीस', 'उनचास', 'पचास',
                    ...
                    print("अभी " + city_name + " में तापमान " + l[int(temp[0])] + " दशमलव " + l[
                        int(temp[1])] + " है और " + d[desc] + " की संभावना है")
                    speak("अभी " + city_name + " में तापमान " + l[int(temp[0])] + " दशमलव " + l[
                        int(temp[1])] + " है और " + d[desc] + " की संभावना है")
                ...
                if (role == 'leader'):
                    ...
                    try:
                        g = geocoder.ip('me')
                        webbrowser.open_new('https://www.google.co.in/maps/dir/' + str(g.latlng[0] - .26) + ',' + str(
                            g.latlng[1] - .23) + "/" + query)
                    except Exception as e:
